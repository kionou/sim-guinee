         ...
         <table id="example1" class="table table-bordered table-striped">
           ...
           <tbody v-else>
               <tr v-for="data   in paginatedItems" :key="data.id">
                   ...
                   <td>
					<div>
                        <router-link v-if="data.type_marche === 1" :to="{ name: 'fiches-enquetes-type-marche-collecte', params: { id: data.id_marche , nom:data.nom_marche }}" style="color: #0d6efd !important; text-decoration: underline;  font-style: italic;">
						{{ data?.nom_marche ?? "-"}}

                        </router-link>
                        <!-- <router-link v-if="data.type_marche === 2" :to="{ name: 'fiches-enquetes-type-marche-grossiste', params: { id: data.id_marche , nom:data.nom_marche }}" style="color: #0d6efd !important; text-decoration: underline;  font-style: italic;">
						{{ data?.nom_marche ?? "-"}}

                        </router-link>
                        <router-link v-else :to="{ name: 'fiches-enquetes-type-marche-consommation', params: { id: data.id_marche , nom:data.nom_marche }}" style="color: #0d6efd !important; text-decoration: underline;  font-style: italic;">
						{{ data?.nom_marche ?? "-"}}
