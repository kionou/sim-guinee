    ...
    <div>
     ...
     <div class="navbar-custom-menu r-side col-4">
        <ul class="nav navbar-nav justify-content-end">	
			...
			<li class="h-40 me-3">
				<button type="button" class="waves-effect waves-circle btn btn-circle btn-primary mb-5"   @click="openModal('add-fiche-betail')"   ><i class="mdi mdi-filter"></i></button>
			</li>
            <li class="h-40">
      ...
      <button class="btn " style="background-color: red; color:white" @click="validateSelection">
        ...
        <div class="modal center-modal fade"  id="add-fiche-betail"  ref="add-fiche-betail" tabindex="-1">
          <div class="modal-dialog ">
          <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title">Recherchez...</h5>
            <button type="button" class=" modal_close btn btn-circle btn-danger close py-1 px-3" @click="closeModal('add-fiche-betail')" >
            ...
            <div class="modal-footer modal-footer-uniform text-end">
              ...
              <button type="button" @click="submitFicheCollecte('add-fiche-betail')" class="waves-effect waves-light btn btn-primary ">Valider</button>
