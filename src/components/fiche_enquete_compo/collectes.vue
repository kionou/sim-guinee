                ...
                <input type="checkbox" v-model="selectedItems" :value="data.id">
                   ...
                   <td style="width: 120px;">
                    <div class="d-flex justify-content-evenly border-0">
                        ...
                        <a href="javascript:vcode(0)" class="btn btn-circle btn-danger btn-xs" @click="HandleIdDelete(data.enquete?.id)" title="" data-toggle="tooltip" data-original-title="Delete"><i class="ti-trash"></i></a>
                    </div>   
					</td > 
               </tr>
           </tbody>
     ...
     if (result.isConfirmed) {
       this.ConfirmeDelete(id);
         ...
         try {
           ...
           const response = await axios.delete(`/enquetes/Fiches/collectes/${id}`, {
             headers: {
               Authorization: `Bearer ${this.loggedInUser.token}`,
             },
