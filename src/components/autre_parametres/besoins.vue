        ...
        <div class="col-12">
            <div class="box">
                <div class="box-header with-border d-flex justify-content-between align-items-center p-3">
                    <h3 class="box-title mb-0"> Liste des produits bésoins</h3>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="row align-items-center p-2  border-bottom " v-for="(produit, index) in Produits" :key="produit.id">
                  ...
                  <div class="col">
                    <div class="input-groupe">
                      <label for="userpassword"
                        >Quantité disponible <span class="text-danger">*</span></label
                      >
                      <MazInput
                ...
                <div class="row  content-group">
                 ...
                 <div class="col">
                   <div class="input-groupe">
                     <label for="userpassword"
                       >Date de disponiblité <span class="text-danger">*</span></label
                     >
                     <MazInput
    ...
    async SubmitDispo(modalId) {
        ...
        try {
          ...
          if (response.status === 200) {
            ...
            this.successmsg(
              "Création du bésoins",
              "Votre bésoins a été créé avec succès !"
            );
    ...
    async ConfirmeDelete(id) {
      ...
      try {
        ...
        if (response.status === 200) {
          this.loading = false;
          this.successmsg(
            "Données  bésoins supprimées",
            "Les données du bésoins ont été supprimées avec succès !"
          );
          await this.fetchMagasins();
        } else {
          this.loading = false;
