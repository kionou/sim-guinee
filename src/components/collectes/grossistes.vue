					...
					<div class="search-bx mx-5">
						<form>
							<div class="input-group">
							  <input type="text" class="form-control" placeholder="Search" aria-label="Recherchez..." aria-describedby="button-addon2" v-model="searchFicheConsoFiche" @input="filterByName">
   ...
   this.v$.step2.$touch();
    ...
    async HandleIdDelete(id) {
     ...
     if (result.isConfirmed) {
       ...
       filterByName() {
this.currentPage = 1;
if (this.searchFicheConsoFiche !== null) {
   const tt = this.searchFicheConsoFiche;
