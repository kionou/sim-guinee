            ...
            <table id="example1" class="table table-bordered table-striped">
             ...
             {{ data?.nbre_enquetes ?? "-" }}
                   ...
                   <td class="text-center" style="width: 70px !important;">
                    <router-link @click="HamdleData(data.marche?.commune_relation)"  :to="{ name: 'fiches-enquetes-type-marche-grossiste', params: { id: data.marche?.id_marche , nom:data.marche?.nom_marche }}" class="text-white btn btn-primary btn-sm">
                    suivre
                  </router-link>
                  </td>
