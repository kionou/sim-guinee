        ...
        <div class="d-inline-block align-items-center">
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"> Gestion des suivis des points de collecte</li>
            </ol>
          </nav>
        </div>
...
import ComposantDebarcadere from "@/components/suivis/point_collecte/famille_debarcadere.vue"
import ComposantMarche from "@/components/suivis/point_collecte/famille_collecte.vue"
