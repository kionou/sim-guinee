    ...
    <div>
        ...
        <div class="content-header">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <h3 class="page-title"> Enquête prix sur marché journalière </h3>
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Enquête prix sur marché journalière</li>
                        </ol>
                    </nav>
                </div>
                                    ...
                                    <td style="width: 120px">
                                        <div class="d-flex justify-content-evenly border-0">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-circle btn-info btn-xs" title=""
                                                @click="HandleIdUpdate(data.id_fiche ,'update-fiche-journaliere' , 'JOURNALIER' )" data-original-title="Update"
                                                ><i
                                                    class="ti-marker-alt"></i></a>
                                            <a href="javascript:void(0)" class="btn btn-circle btn-danger btn-xs"
                                                @click="HandleIdDelete(data.id_fiche , 'JOURNALIER')" title="" data-toggle="tooltip"
  ...
  methods: {
    ...
    async SubmitPrixJournaliere(modalId) {
      ...
      if (this.v$.$errors.length == 0) {
        ...
        try {
          const response = await axios.post("/enquetes/marches-prix/journaliers", data, {
            headers: {
              Authorization: `Bearer ${this.loggedInUser.token}`,
            }
          });
    ...
    async submitUpdate(modalId) {
      ...
      if (this.v$.$errors.length == 0) {
        ...
        try {
          const response = await axios.put(`/enquetes/marches-prix/journaliers/edition?id=${this.ToId}`, data, {
            headers: {
              Authorization: `Bearer ${this.loggedInUser.token}`,
            },
          });
