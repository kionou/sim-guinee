    ...
    <div>
        ...
        <div class="content-header">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <h3 class="page-title"> Enquête prix sur marché consommation </h3>
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Enquête prix sur marché consommation</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <ul class="nav navbar-nav justify-content-end">
                            ...
                            <li class="h-40">
                                <button  type="button" class="waves-effect waves-circle btn btn-circle btn-primary mb-5"
                                    data-toggle="modal" data-target="#add-magasin">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody v-else>
                                <tr v-for="(data) in paginatedItems" :key="data.id_magasin">
                                    ...
                                    <td style="width: 90px;" class="text-center">{{ data?.prix_fg_kg ?? "-" }}</td>
                                    ...
                                    <td style="width: 120px">
                                        <div class="d-flex justify-content-evenly border-0">
                                            <a href="javascript:void(0)" class="btn btn-circle btn-success btn-xs" title=""
                                                ...
                                                data-toggle="modal" data-target="#Detail-conso"><i
                                                    class="ti-eye"></i></a>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                        ...
                        <div class="row mt-3 content-group">
                            <div class="col-6">
                                <div class="input-groupe">
                                    ...
                                    <MazInput v-model="step1.code_magasin" color="secondary" name="step1.code_magasin"
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    ...
                                    <MazInput v-model="step1.nom_magasin" color="secondary" name="step1.nom_magasin"
                                        size="sm" rounded-size="sm" type="text" />
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                      Prix mesure <span class="text-danger">*</span></label>
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                      prix_kg_litre <span class="text-danger">*</span>
                                    </label>
                                    <MazSelect v-model="step1.commune" color="secondary" name="step1.commune" size="sm"
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                      Niveau d'approvisionement <span class="text-danger">*</span>
                                    </label>
                                    <MazSelect v-model="step1.collecteur" color="secondary" name="step1.collecteur"
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Observation <span class="text-danger">*</span></label>
                    ...
                    <div class="modal-footer modal-footer-uniform text-end">
                        <button type="button" @click="SubmitMagasins('add-magasin')"
        ...
        <div class="modal center-modal fade" id="Detail-conso" ref="Detail-conso" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                        ...
                        <div class="card  max-w-p100" style="margin-bottom:0 !important">
										...
										<div class="card-body">
											...
											<div class="">
                                                <div  class="row">
                            <div  class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                <div  class="mt-1">Unité : <span 
                                        class="fw-semibold fs-16" data-bs-toggle="tooltip" title="Current Salary">{{detailData?.unite_relation?.nom_unite}}</span></div>
                            </div>
                            <div  class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                <div  class="mt-1">Poids Unitaire : <span 
                                        class="fw-semibold fs-16" data-bs-toggle="tooltip" title="Current Salary">{{detailData?.poids_unitaire}}</span>
                                </div>
                            </div>
                            <div  class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                <div  class="mt-1">Prix de mesure: <span 
                                        class="fw-semibold fs-16" data-bs-toggle="tooltip" title="Current Salary">{{detailData?.prix_mesure}}</span></div>
                            </div>
                                            </div>
                                            <div  class="row">
                            <div  class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                <div  class="mt-1">prix_fg_kg : <span 
                                        class="fw-semibold fs-16" data-bs-toggle="tooltip" title="Current Salary">{{detailData?.prix_fg_kg}}</span></div>
                            </div>
                            <div  class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                <div  class="mt-1">prix_kg_litre : <span 
                                        class="fw-semibold fs-16" data-bs-toggle="tooltip" title="Current Salary">{{detailData?.prix_kg_litre}}</span>
                                </div>
                            </div>
                            <div  class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                <div  class="mt-1">Niveau Approvisionement: <span 
                                        class="fw-semibold fs-16" data-bs-toggle="tooltip" title="Current Salary">{{detailData?.niveau_approvisionement}}</span></div>
                            </div>
                                            </div>
                                            <div  class="row">
