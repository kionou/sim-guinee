                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody v-else>
                                <tr v-for="(data) in paginatedItems" :key="data.id_magasin">
                                    ...
                                    <td style="width: 130px;" class="text-center">{{ data?.localite_achat ?? "-" }} </td>
                                    <td style="width: auto;"  class="text-center">{{ data?.fournisseur_achat ?? "-" }}</td>
                                    <td style="width: 120px;" class="text-center">
                                        {{ data?.poids_total_achat ?? "-"}}
                                    </td>
                                    <td style="width: 120px;" class="text-center">{{ data?.unite_vente ?? "-" }}</td>
		  ...
		  <div class="box box-default">
			...
			<div class="box-body wizard-content">
				<form action="#" class="tab-wizard wizard-circle">
					...
					<section>
						   <div class="row mt-3 content-group">
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Poids de stock <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Localite d'origine <span class="text-danger">*</span></label>
					...
					<!-- Step 2 -->
					<h6> Infos sur l'Achat</h6>
					<section>
                        <div class="row mt-3 content-group">
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Unité d'achat <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.code_magasin" color="secondary" name="step1.code_magasin"
                                        size="sm" rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.code_magasin.$error">{{
                                        v$.step1.code_magasin.$errors[0].$message
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                     Poids moyen d'unite d'achat <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.capacite" color="secondary" name="step1.capacite" size="sm"
                                        rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.capacite.$error">{{
                                        v$.step1.capacite.$errors[0].$message
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Poids total d'achat <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.longitude" color="secondary" name="step1.longitude" size="sm"
                                        rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.longitude.$error">{{
                                        v$.step1.longitude.$errors[0].$message
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Localite d'achat <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.latitude" color="secondary" name="step1.latitude" size="sm"
                                        rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.latitude.$error">{{
                                        v$.step1.latitude.$errors[0].$message
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Fournisseur d'achat <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.latitude" color="secondary" name="step1.latitude" size="sm"
                                        rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.latitude.$error">{{
                                        v$.step1.latitude.$errors[0].$message
                            ...
                            <div class="col-12">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Fournisseur principal <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.latitude" color="secondary" name="step1.latitude" size="sm"
                                        rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.latitude.$error">{{
                                        v$.step1.latitude.$errors[0].$message
					...
					<!-- Step 3 -->
					<h6>Infos sur la Vente</h6>
					<section>
						<div class="row mt-3 content-group">
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Unité de vente <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.code_magasin" color="secondary" name="step1.code_magasin"
                                        size="sm" rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.code_magasin.$error">{{
                                        v$.step1.code_magasin.$errors[0].$message
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Nombre d'unite de vente  <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.nom_magasin" color="secondary" name="step1.nom_magasin"
                                        size="sm" rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.nom_magasin.$error">{{
                                        v$.step1.nom_magasin.$errors[0].$message
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                     Poids moyen d'unite de vente  <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.capacite" color="secondary" name="step1.capacite" size="sm"
                                        rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.capacite.$error">{{
                                        v$.step1.capacite.$errors[0].$message
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Poids total d'unite de vente  <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.longitude" color="secondary" name="step1.longitude" size="sm"
                                        rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.longitude.$error">{{
                                        v$.step1.longitude.$errors[0].$message
                            ...
                            <div class="col-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Client de vente   <span class="text-danger">*</span></label>
                                    <MazInput v-model="step1.latitude" color="secondary" name="step1.latitude" size="sm"
                                        rounded-size="sm" type="text" />
                                    <small v-if="v$.step1.latitude.$error">{{
                                        v$.step1.latitude.$errors[0].$message
