    ...
    <div>
      ...
      <div class="content-header">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <h3 class="page-title"> Enquête prix sur marché Port </h3>
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Enquête prix sur marché Port</li>
              </ol>
            </nav>
          </div>
                    ...
                    <td style="width: 130px">
                      ...
                      <div class="d-flex justify-content-evenly border-0">
                        ...
                        <a href="javascript:void(0)" class="btn btn-circle btn-info btn-xs" title=""
                          @click="HandleIdUpdate(data.id_fiche , 'update-prix-collecte' , 'PORT')" data-original-title="Update"><i
                            class="ti-marker-alt"></i></a>
                        <a href="javascript:void(0)" class="btn btn-circle btn-danger btn-xs"
                          @click="HandleIdDelete(data.id_fiche , 'PORT')" title="" data-toggle="tooltip"
