    ...
    <div>
        ...
        <div class="content-header">
			<div class="d-flex align-items-center justify-content-between">
					...
					<h3 class="page-title"> Fiches d'enquêtes grossistes</h3>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Fiches d'enquêtes grossistes</li>
							</ol>
						</nav>
					</div>
    ...
    <div class="tab-content tabcontent-border">
        <div class="tab-pane active" id="naturelle" role="tabpanel">
							<div class="p-15">
                                ...
                                <Grossistes :enquetes="[]"  :nom="nom" :id="id" @enquete-updated="handleEnqueteUpdated" ></Grossistes>
							</div>
						</div>
      ...
      >
        <div class="p-15">
          ...
          <div >
            ...
            <Grossistes :enquetes="item.enquetes" :year="item.year" :nom="nom" :id="id" @enquete-updated="handleEnqueteUpdated" ></Grossistes>
          </div>
        </div>
      </div>
    </div>
