<template>
    <div>
      ...
      <div class="content-header">
        <div class="d-flex align-items-center justify-content-between">
          <h3 class="page-title">Fiches d'enquêtes debarcadères</h3>
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Fiches d'enquêtes debarcadères</li>
              </ol>
            </nav>
          </div>
        </div>
  ...
  <script>
  import Collectes from "@/components/fiche_enquete_compo/debarcadere.vue"
