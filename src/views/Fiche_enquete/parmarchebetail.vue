<template>
    <div>
      ...
      <div class="content-header">
        <div class="d-flex align-items-center justify-content-between">
          <h3 class="page-title">Fiches d'enquêtes bétail</h3>
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Fiches d'enquêtes bétail</li>
              </ol>
            </nav>
          </div>
        </div>
  ...
  <script>
  import Collectes from "@/components/fiche_enquete_compo/betail.vue"
