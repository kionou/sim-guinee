    ...
    <header class="main-header">
      <div class="d-flex align-items-center logo-box justify-content-center">
        ...
        <router-link to="/" class="logo">
          <!-- logo-->
          <div class="logo-mini">
            <span class="light-logo"><img src="@/assets/img/logo_mobile.png" style="width: 58px !important; "
                alt="logo"></span>
            <span class="dark-logo"><img src="@/assets/img/logo_mobile.png" style="width: 58px !important; "
                alt="logo"></span>
          </div>
          <!-- logo-->
          <div class="logo-lg">
        ...
        <div class="navbar-custom-menu r-side">
          <ul class="nav navbar-nav">
            ...
            <li style="cursor: pointer !important;"
              class="custom-dropdown user user-menu d-flex flex-row-reverse align-items-center " @click="toggleDropdown">
              <span class="font-size-16" style="font-weight:bolder !important; margin-right:10px !important ; "> {{
              ...
              <ul v-if="isOpen" class="custom-dropdown-menu">
                <li class="user-body">
                  <router-link class="custom-dropdown-item" to="/sim/profil"><i class="ti-user text-muted mr-2"></i>
                    Profil</router-link>
                  <div class="custom-dropdown-divider"></div>
                  <a class="custom-dropdown-item" href="#" @click="logout"><i class="ti-lock text-muted mr-2"></i>
                    Deconnexion</a>
                </li>
              </ul>
            </li>
            ...
            <transition name="slide">
              <ul v-show="openMenus.parametrages" class="submenu">
                <li style="padding-top:6px !important">
                  <router-link to="/sim/utilisateurs" @click="setActiveSubMenu('/sim/utilisateurs')"
                ...
                <li style="padding-top:6px !important">
                  <router-link to="/sim/localites" @click="setActiveSubMenu('/sim/localites')"
                ...
                <li style="padding-top:6px !important"><router-link to="/sim/collectes"
                    ...
                    style="color:var(--color-primary)"><i class="icon-Commit me-2"><span class="path1"></span><span
                        class="path2"></span></i>Agents de collecte</router-link></li>
                ...
                <li style="padding-top:6px !important"><router-link to="/sim/types-marches"
                    ...
                    style="color:var(--color-primary)"><i class="icon-Commit me-2"><span class="path1"></span><span
                        class="path2"></span></i>Points de collecte</router-link></li>

                        <li style="padding-top:6px !important"><router-link to="/sim/magasins"
                    @click="setActiveSubMenu('/sim/magasins')" :class="{ active: activeSubMenu === '/sim/magasins' }"
                    style="color:var(--color-primary)"><i class="icon-Commit me-2"><span class="path1"></span><span
                        class="path2"></span></i>Magasins d'intrants</router-link></li>

                <!-- <li style="padding-top:6px !important"><router-link to="/sim/debarcaderes"
                    @click="setActiveSubMenu('/sim/debarcaderes')"
                    :class="{ active: activeSubMenu === '/sim/debarcaderes' }" style="color:var(--color-primary)"><i
                      class="icon-Commit me-2"><span class="path1"></span><span
                        class="path2"></span></i>Debarcadères</router-link></li> -->

                <li style="padding-top:6px !important"><router-link to="/sim/produits"
                    @click="setActiveSubMenu('/sim/produits')"
                    :class="{ active: activeSubMenu === '/sim/produits' }" style="color:var(--color-primary)"><i
                      class="icon-Commit me-2"><span class="path1"></span><span class="path2"></span></i>Gestion des
...
.custom-dropdown-menu {
  ...
  z-index: 1000;
  width: 200px;
  /* Vous pouvez ajuster cette largeur */
}
...
.slide-leave-active {
  ...
  max-height: 200px;
  /* Ajustez cette valeur selon la hauteur maximale de votre menu */
  overflow: hidden;
}
...
.theme-primary a:focus {
  ...
  /* La couleur change lorsque l'élément est actif */
}
